...
export default function Loader() {
  return (
    <div className="w-full bg-[#030711] text-white">
      {/* Question Cards */}
      {[1, 2, 3, 4, 5].map((item) => (
        <div key={item} className="bg-[#040a1a]   rounded-md p-4 mb-4  ">
          <div className="flex  items-start space-x-4 h-full">
            <div className="w-10 h-10 animate-pulse bg-gray-600 rounded-full shimmer flex-shrink-0"></div>

            <div className="flex-1 animate-pulse flex flex-col justify-between h-full">
              <div>
